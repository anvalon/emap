...
% -----------------------------------------------------------------
bound_extended(Input, Results) :-                  % Entry point for analyzing bound words               % Main entry
...
% -----------------------------------------------------------------
bound_complete(Input, Results) :-                  % Core logic for the radical part                     % Radical logic
